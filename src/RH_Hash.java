...
public class RH_Hash<Key,Value> {
    ...
    public void push(Key k0, Value v0) {
        ...
        if (table[h0 + shift] != null){
            //Если (значение хэша у элемента1 в этой ячейке) меньше (значения хэша нашего эл-та0), то достаем эл-т1 из ячейки, кладем наш элемент0 в ячейку и вып проц. для эл1, к след. ячейке
            p = table[h0 + shift];
